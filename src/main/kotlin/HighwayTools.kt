...
object HighwayTools : PluginModule(
    ...
    val interactionLimit by setting("Interaction Limit", 20, 1..100, 1, { page == Page.MINING && multiBreak }, description = "Set the interaction limit per second", unit = " interactions/s")
